...
{
	switch (path_type) {
	case SDL_PATHTYPE_NONE:			return MORTAR_PATHTYPE_NONE;
	case SDL_PATHTYPE_FILE:			return MORTAR_PATHTYPE_FILE;
	case SDL_PATHTYPE_DIRECTORY:	return MORTAR_PATHTYPE_DIRECTORY;
	case SDL_PATHTYPE_OTHER:		return MORTAR_PATHTYPE_OTHER;
	default:
		abort();
	}
}
...
static SDL_Folder folder_mortar_to_sdl3(MORTAR_Folder mortar_folder)
{
	...
	case MORTAR_FOLDER_DOCUMENTS: return SDL_FOLDER_DOCUMENTS;
	default:
		abort();
	}
}
