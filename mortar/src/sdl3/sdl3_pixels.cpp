...
MORTAR_PixelFormat pixelformat_sdl3_to_mortar(SDL_PixelFormat format)
{
	...
	switch (format) {
	case SDL_PIXELFORMAT_INDEX8: return MORTAR_PIXELFORMAT_INDEX8;
	case SDL_PIXELFORMAT_RGBX8888: return MORTAR_PIXELFORMAT_RGBX8888;
	case SDL_PIXELFORMAT_XBGR8888: return MORTAR_PIXELFORMAT_XBGR8888;
	case SDL_PIXELFORMAT_BGRX8888: return MORTAR_PIXELFORMAT_BGRX8888;
	case SDL_PIXELFORMAT_XRGB8888: return MORTAR_PIXELFORMAT_XRGB8888;
	case SDL_PIXELFORMAT_ARGB8888: return MORTAR_PIXELFORMAT_ARGB8888;
	case SDL_PIXELFORMAT_BGRA8888: return MORTAR_PIXELFORMAT_BGRA8888;
	case SDL_PIXELFORMAT_RGBA8888: return MORTAR_PIXELFORMAT_RGBA8888;
	case SDL_PIXELFORMAT_ABGR8888: return MORTAR_PIXELFORMAT_ABGR8888;
	case SDL_PIXELFORMAT_BGR24: return MORTAR_PIXELFORMAT_BGR24;
	case SDL_PIXELFORMAT_UNKNOWN: return MORTAR_PIXELFORMAT_UNKNOWN;
	default:
		abort();
	}
}
...
SDL_PixelFormat pixelformat_mortar_to_sdl3(MORTAR_PixelFormat format)
{
	...
	switch (format) {
	case MORTAR_PIXELFORMAT_INDEX8:		return SDL_PIXELFORMAT_INDEX8;
	case MORTAR_PIXELFORMAT_RGBA32:		return SDL_PIXELFORMAT_RGBA32;
	case MORTAR_PIXELFORMAT_RGBX32:		return SDL_PIXELFORMAT_RGBX32;
	case MORTAR_PIXELFORMAT_XRGB32:		return SDL_PIXELFORMAT_XRGB32;
	case MORTAR_PIXELFORMAT_ARGB32:		return SDL_PIXELFORMAT_ARGB32;
	case MORTAR_PIXELFORMAT_RGBX8888:	return SDL_PIXELFORMAT_RGBX8888;
	case MORTAR_PIXELFORMAT_XBGR8888:	return SDL_PIXELFORMAT_XBGR8888;
	case MORTAR_PIXELFORMAT_BGRX8888:	return SDL_PIXELFORMAT_BGRX8888;
	case MORTAR_PIXELFORMAT_XRGB8888:	return SDL_PIXELFORMAT_XRGB8888;
	case MORTAR_PIXELFORMAT_ARGB8888:	return SDL_PIXELFORMAT_ARGB8888;
	case MORTAR_PIXELFORMAT_BGRA8888:	return SDL_PIXELFORMAT_BGRA8888;
	case MORTAR_PIXELFORMAT_RGBA8888:	return SDL_PIXELFORMAT_RGBA8888;
	case MORTAR_PIXELFORMAT_ABGR8888:	return SDL_PIXELFORMAT_ABGR8888;
	case MORTAR_PIXELFORMAT_BGR24:		return SDL_PIXELFORMAT_BGR24;
	case MORTAR_PIXELFORMAT_UNKNOWN: return SDL_PIXELFORMAT_UNKNOWN;
	default:
		abort();
	}
}
...
{
	MORTAR_SDL_Palette *mortar_sdl_palette = (MORTAR_SDL_Palette *)SDL_calloc(sizeof(MORTAR_SDL_Palette), 1);
...
void MORTAR_DestroyPalette(MORTAR_Palette *mortar_palette)
{
	if (mortar_palette) {
		...
		bool destroy = mortar_sdl_palette->sdl3_palette->refcount == 1;
...
bool MORTAR_SetPaletteColors(MORTAR_Palette *mortar_palette, const MORTAR_Color *mortar_colors, int firstcolor, int ncolors)
{
...
uint32_t MORTAR_MapRGBA(const MORTAR_PixelFormatDetails *format, const MORTAR_Palette *mortar_palette, uint8_t r, uint8_t g, uint8_t b, uint8_t a)
{
...
uint32_t MORTAR_MapRGB(const MORTAR_PixelFormatDetails *format, const MORTAR_Palette *mortar_palette, uint8_t r, uint8_t g, uint8_t b)
{
	SDL_Palette *sdl3_palette = mortar_palette ? palette_mortar_to_sdl3(mortar_palette) : NULL;
	return SDL_MapRGB((SDL_PixelFormatDetails *)format->reserved, sdl3_palette, r, g, b);
}

void MORTAR_GetRGBA(uint32_t pixelvalue, const MORTAR_PixelFormatDetails *format, const MORTAR_Palette *mortar_palette, uint8_t *r, uint8_t *g, uint8_t *b, uint8_t *a)
{
	SDL_Palette *sdl3_palette = mortar_palette ? palette_mortar_to_sdl3(mortar_palette) : NULL;
	return SDL_GetRGBA(pixelvalue, (SDL_PixelFormatDetails *)format->reserved, sdl3_palette, r, g, b, a);
}

MORTAR_PixelFormat MORTAR_GetPixelFormatForMasks(int bpp, uint32_t Rmask, uint32_t Gmask, uint32_t Bmask, uint32_t Amask)
{
