...
{
	switch (eventtype) {
	case MORTAR_EVENT_QUIT:							return SDL_EVENT_QUIT;
	case MORTAR_EVENT_TERMINATING:					return SDL_EVENT_TERMINATING;
	case MORTAR_EVENT_WINDOW_PIXEL_SIZE_CHANGED:	return SDL_EVENT_WINDOW_PIXEL_SIZE_CHANGED;
	case MORTAR_EVENT_WINDOW_FOCUS_GAINED:			return SDL_EVENT_WINDOW_FOCUS_GAINED;
	case MORTAR_EVENT_WINDOW_FOCUS_LOST:			return SDL_EVENT_WINDOW_FOCUS_LOST;
	case MORTAR_EVENT_WINDOW_CLOSE_REQUESTED:		return SDL_EVENT_WINDOW_CLOSE_REQUESTED;
	case MORTAR_EVENT_KEY_DOWN:						return SDL_EVENT_KEY_DOWN;
	case MORTAR_EVENT_KEY_UP:						return SDL_EVENT_KEY_UP;
	case MORTAR_EVENT_KEYBOARD_ADDED:				return SDL_EVENT_KEYBOARD_ADDED;
	case MORTAR_EVENT_KEYBOARD_REMOVED:				return SDL_EVENT_KEYBOARD_REMOVED;
	case MORTAR_EVENT_MOUSE_MOTION:					return SDL_EVENT_MOUSE_MOTION;
	case MORTAR_EVENT_MOUSE_BUTTON_DOWN:			return SDL_EVENT_MOUSE_BUTTON_DOWN;
	case MORTAR_EVENT_MOUSE_BUTTON_UP:				return SDL_EVENT_MOUSE_BUTTON_UP;
	case MORTAR_EVENT_MOUSE_ADDED:					return SDL_EVENT_MOUSE_ADDED;
	case MORTAR_EVENT_MOUSE_REMOVED:				return SDL_EVENT_MOUSE_REMOVED;
	case MORTAR_EVENT_GAMEPAD_AXIS_MOTION:			return SDL_EVENT_GAMEPAD_AXIS_MOTION;
	case MORTAR_EVENT_GAMEPAD_BUTTON_DOWN:			return SDL_EVENT_GAMEPAD_BUTTON_DOWN;
	case MORTAR_EVENT_GAMEPAD_BUTTON_UP:			return SDL_EVENT_GAMEPAD_BUTTON_UP;
	case MORTAR_EVENT_GAMEPAD_ADDED:				return SDL_EVENT_GAMEPAD_ADDED;
	case MORTAR_EVENT_GAMEPAD_REMOVED:				return SDL_EVENT_GAMEPAD_REMOVED;
	case MORTAR_EVENT_FINGER_DOWN:					return SDL_EVENT_FINGER_DOWN;
	case MORTAR_EVENT_FINGER_UP:					return SDL_EVENT_FINGER_UP;
	case MORTAR_EVENT_FINGER_MOTION:				return SDL_EVENT_FINGER_MOTION;
	case MORTAR_EVENT_FINGER_CANCELED: 				return SDL_EVENT_FINGER_CANCELED;
	default:
...
{
	switch (eventtype) {
	case SDL_EVENT_QUIT:						*mortar_eventtype = MORTAR_EVENT_QUIT; 							return true;
	case SDL_EVENT_TERMINATING: 				*mortar_eventtype = MORTAR_EVENT_TERMINATING;					return true;
	case SDL_EVENT_WINDOW_PIXEL_SIZE_CHANGED:	*mortar_eventtype = MORTAR_EVENT_WINDOW_PIXEL_SIZE_CHANGED; 	return true;
	case SDL_EVENT_WINDOW_FOCUS_GAINED:			*mortar_eventtype = MORTAR_EVENT_WINDOW_FOCUS_GAINED; 			return true;
	case SDL_EVENT_WINDOW_FOCUS_LOST:			*mortar_eventtype = MORTAR_EVENT_WINDOW_FOCUS_LOST; 			return true;
	case SDL_EVENT_WINDOW_CLOSE_REQUESTED:		*mortar_eventtype = MORTAR_EVENT_WINDOW_CLOSE_REQUESTED; 		return true;
	case SDL_EVENT_KEY_DOWN:					*mortar_eventtype = MORTAR_EVENT_KEY_DOWN; 						return true;
	case SDL_EVENT_KEY_UP:						*mortar_eventtype = MORTAR_EVENT_KEY_UP; 						return true;
	case SDL_EVENT_KEYBOARD_ADDED:				*mortar_eventtype = MORTAR_EVENT_KEYBOARD_ADDED; 				return true;
	case SDL_EVENT_KEYBOARD_REMOVED:			*mortar_eventtype = MORTAR_EVENT_KEYBOARD_REMOVED; 				return true;
	case SDL_EVENT_MOUSE_MOTION:				*mortar_eventtype = MORTAR_EVENT_MOUSE_MOTION; 					return true;
	case SDL_EVENT_MOUSE_BUTTON_DOWN:			*mortar_eventtype = MORTAR_EVENT_MOUSE_BUTTON_DOWN; 			return true;
	case SDL_EVENT_MOUSE_BUTTON_UP:				*mortar_eventtype = MORTAR_EVENT_MOUSE_BUTTON_UP; 				return true;
	case SDL_EVENT_MOUSE_ADDED:					*mortar_eventtype = MORTAR_EVENT_MOUSE_ADDED; 					return true;
	case SDL_EVENT_MOUSE_REMOVED:				*mortar_eventtype = MORTAR_EVENT_MOUSE_REMOVED; 				return true;
	case SDL_EVENT_GAMEPAD_AXIS_MOTION:			*mortar_eventtype = MORTAR_EVENT_GAMEPAD_AXIS_MOTION; 			return true;
	case SDL_EVENT_GAMEPAD_BUTTON_DOWN:			*mortar_eventtype = MORTAR_EVENT_GAMEPAD_BUTTON_DOWN; 			return true;
	case SDL_EVENT_GAMEPAD_BUTTON_UP:			*mortar_eventtype = MORTAR_EVENT_GAMEPAD_BUTTON_UP; 			return true;
	case SDL_EVENT_GAMEPAD_ADDED:				*mortar_eventtype = MORTAR_EVENT_GAMEPAD_ADDED; 				return true;
	case SDL_EVENT_GAMEPAD_REMOVED:				*mortar_eventtype = MORTAR_EVENT_GAMEPAD_REMOVED; 				return true;
	case SDL_EVENT_FINGER_DOWN:					*mortar_eventtype = MORTAR_EVENT_FINGER_DOWN; 					return true;
	case SDL_EVENT_FINGER_UP:					*mortar_eventtype = MORTAR_EVENT_FINGER_UP; 					return true;
	case SDL_EVENT_FINGER_MOTION:				*mortar_eventtype = MORTAR_EVENT_FINGER_MOTION; 				return true;
	case SDL_EVENT_FINGER_CANCELED: 			*mortar_eventtype = MORTAR_EVENT_FINGER_CANCELED; 				return true;
	default:
