...
{
	switch (axis) {
	case MORTAR_GAMEPAD_AXIS_LEFTX: 		return SDL_GAMEPAD_AXIS_LEFTX;
	case MORTAR_GAMEPAD_AXIS_LEFTY: 		return SDL_GAMEPAD_AXIS_LEFTY;
	case MORTAR_GAMEPAD_AXIS_RIGHTX: 		return SDL_GAMEPAD_AXIS_RIGHTX;
	case MORTAR_GAMEPAD_AXIS_RIGHTY: 		return SDL_GAMEPAD_AXIS_RIGHTY;
	case MORTAR_GAMEPAD_AXIS_RIGHT_TRIGGER: return SDL_GAMEPAD_AXIS_RIGHT_TRIGGER;
	default: abort();
	}
}
...
bool MORTAR_RumbleGamepad(MORTAR_Gamepad *gamepad, uint16_t low_frequency_rumble, uint16_t high_frequency_rumble, uint32_t duration_ms)
{
