...
{
	return (MORTAR_Texture *)SDL_CreateTexture((SDL_Renderer *)renderer, pixelformat_mortar_to_sdl3(format), SDL_TEXTUREACCESS_STREAMING, w, h);
}
...
bool MORTAR_RenderTexture(MORTAR_Renderer *renderer, MORTAR_Texture *texture, const MORTAR_FRect *srcrect, const MORTAR_FRect *dstrect)
{
	SDL_FRect sdl3_srcrect_storage;
	SDL_FRect sdl3_dstrect_storage;
	return SDL_RenderTexture((SDL_Renderer *)renderer, (SDL_Texture *)texture, frect_mortar_to_sdl3(srcrect, &sdl3_srcrect_storage), frect_mortar_to_sdl3(dstrect, &sdl3_dstrect_storage));
}
