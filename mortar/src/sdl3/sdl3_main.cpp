...
{
	switch (result) {
	case MORTAR_APP_CONTINUE: return SDL_APP_CONTINUE;
	case MORTAR_APP_SUCCESS: return SDL_APP_SUCCESS;
	case MORTAR_APP_FAILURE: return SDL_APP_FAILURE;
	default: abort();
	}
}
...
{
	switch (result) {
	case SDL_APP_CONTINUE: return MORTAR_APP_CONTINUE;
	case SDL_APP_SUCCESS: return MORTAR_APP_SUCCESS;
	case SDL_APP_FAILURE: return MORTAR_APP_FAILURE;
	default: abort();
	}
}
