...
{
	switch (whence) {
	case MORTAR_IO_SEEK_SET: return SDL_IO_SEEK_SET;
	case MORTAR_IO_SEEK_CUR: return SDL_IO_SEEK_CUR;
	case MORTAR_IO_SEEK_END: return SDL_IO_SEEK_END;
	default: abort();
	}
}
...
{
	switch (status) {
	case SDL_IO_STATUS_READY:		return MORTAR_IO_STATUS_READY;
	case SDL_IO_STATUS_ERROR:		return MORTAR_IO_STATUS_ERROR;
	case SDL_IO_STATUS_EOF:			return MORTAR_IO_STATUS_EOF;
	case SDL_IO_STATUS_NOT_READY:	return MORTAR_IO_STATUS_NOT_READY;
	case SDL_IO_STATUS_READONLY:	return MORTAR_IO_STATUS_READONLY;
	case SDL_IO_STATUS_WRITEONLY:	return MORTAR_IO_STATUS_WRITEONLY;
	default: abort();
	}
}
