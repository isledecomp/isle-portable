...
{
	MORTAR_EventType type; /**< MORTAR_EVENT_JOYSTICK_ADDED or MORTAR_EVENT_JOYSTICK_REMOVED or MORTAR_EVENT_JOYSTICK_UPDATE_COMPLETE */
	uint32_t reserved;
	uint64_t timestamp;   /**< In nanoseconds, populated using MORTAR_GetTicksNS() */
...
{
	uint32_t type;        /**< MORTAR_EVENT_USER through MORTAR_EVENT_LAST, uint32_t because these are not in the MORTAR_EventType enumeration */
	uint32_t reserved;
	uint64_t timestamp;   /**< In nanoseconds, populated using MORTAR_GetTicksNS() */
