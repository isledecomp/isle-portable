...
extern MORTAR_DECLSPEC bool MORTAR_GetClosestFullscreenDisplayMode(MORTAR_DisplayID displayID, int w, int h, float refresh_rate, bool include_high_density_modes, MORTAR_DisplayMode *closest);
...
extern MORTAR_DECLSPEC bool MORTAR_EXT_SetWindowProperty(MORTAR_Window *window, MORTAR_WindowProperty property, void *value);

extern MORTAR_DECLSPEC void *MORTAR_EXT_GetWindowProperty(MORTAR_Window *window, MORTAR_WindowProperty property, void *default_value);
