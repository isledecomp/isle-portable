...
extern MORTAR_DECLSPEC MORTAR_Surface * MORTAR_CreateSurfaceFrom(int width, int height, MORTAR_PixelFormat format, void *pixels, int pitch);
...
extern MORTAR_DECLSPEC bool MORTAR_BlitSurface(MORTAR_Surface *src, const MORTAR_Rect *srcrect, MORTAR_Surface *dst, const MORTAR_Rect *dstrect);
...
extern MORTAR_DECLSPEC bool MORTAR_BlitSurfaceScaled(MORTAR_Surface *src, const MORTAR_Rect *srcrect, MORTAR_Surface *dst, const MORTAR_Rect *dstrect, MORTAR_ScaleMode scaleMode);
...
extern MORTAR_DECLSPEC void * MORTAR_EXT_GetSurfaceProperty(MORTAR_Surface *mortar_surface, MORTAR_SurfaceProperty key, void *default_value);
