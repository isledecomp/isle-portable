...
extern MORTAR_DECLSPEC bool MORTAR_SetPaletteColors(MORTAR_Palette *palette, const MORTAR_Color *colors, int firstcolor, int ncolors);

extern MORTAR_DECLSPEC const MORTAR_PixelFormatDetails * MORTAR_GetPixelFormatDetails(MORTAR_PixelFormat format);

extern MORTAR_DECLSPEC uint32_t MORTAR_MapRGBA(const MORTAR_PixelFormatDetails *format, const MORTAR_Palette *palette, uint8_t r, uint8_t g, uint8_t b, uint8_t a);

extern MORTAR_DECLSPEC uint32_t MORTAR_MapRGB(const MORTAR_PixelFormatDetails *format, const MORTAR_Palette *palette, uint8_t r, uint8_t g, uint8_t b);

extern MORTAR_DECLSPEC void MORTAR_GetRGBA(uint32_t pixelvalue, const MORTAR_PixelFormatDetails *format, const MORTAR_Palette *palette, uint8_t *r, uint8_t *g, uint8_t *b, uint8_t *a);

extern MORTAR_DECLSPEC MORTAR_PixelFormat MORTAR_GetPixelFormatForMasks(int bpp, uint32_t Rmask, uint32_t Gmask, uint32_t Bmask, uint32_t Amask);
