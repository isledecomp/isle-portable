...
extern MORTAR_DECLSPEC MORTAR_Texture * MORTAR_CreateTexture(MORTAR_Renderer *renderer, MORTAR_PixelFormat format, int w, int h);

extern MORTAR_DECLSPEC void MORTAR_DestroyTexture(MORTAR_Texture *texture);

extern MORTAR_DECLSPEC bool MORTAR_RenderTexture(MORTAR_Renderer *renderer, MORTAR_Texture *texture, const MORTAR_FRect *srcrect, const MORTAR_FRect *dstrect);

extern MORTAR_DECLSPEC bool MORTAR_RenderPresent(MORTAR_Renderer *renderer);

extern MORTAR_DECLSPEC bool MORTAR_UpdateTexture(MORTAR_Texture *texture, const MORTAR_Rect *rect, const void *pixels, int pitch);
