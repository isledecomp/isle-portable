...
typedef void (*MORTAR_AudioStreamCallback)(void *userdata, MORTAR_AudioStream *stream, int additional_amount, int total_amount);

extern MORTAR_DECLSPEC MORTAR_AudioStream * MORTAR_EX_OpenAudioPlaybackDevice(const MORTAR_AudioSpec *spec, MORTAR_AudioStreamCallback callback, void *userdata);
