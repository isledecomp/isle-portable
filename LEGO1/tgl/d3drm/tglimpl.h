...
Result
RendererCreateView(IDirect3DRM2*, const IDirect3DRMDevice2*, const IDirect3DRMFrame2*, unsigned int x, unsigned int y, unsigned int width, unsigned int height, IDirect3DRMViewport*&);
...
Result RendererSetTextureDefaultShadeCount(IDirect3DRM2*, unsigned int);
Result RendererSetTextureDefaultColorCount(IDirect3DRM2*, unsigned int);
void RendererDestroy(IDirect3DRM2*);
unsigned int DeviceGetWidth(IDirect3DRMDevice2*);
unsigned int DeviceGetHeight(IDirect3DRMDevice2*);
Result DeviceSetColorModel(IDirect3DRMDevice2*, ColorModel);
Result DeviceSetShadingModel(IDirect3DRMDevice2*, ShadingModel);
Result DeviceSetShadeCount(IDirect3DRMDevice2*, unsigned int);
...
unsigned int DeviceGetTrianglesDrawn(IDirect3DRMDevice2*);
...
Result ViewForceUpdate(IDirect3DRMViewport*, unsigned int x, unsigned int y, unsigned int width, unsigned int height);
...
public:
	...
	unsigned int GetTrianglesDrawn();
...
inline Result RendererImpl::SetTextureDefaultShadeCount(unsigned int shadeCount)
{
	assert(m_data);
...
inline Result RendererImpl::SetTextureDefaultColorCount(unsigned int colorCount)
{
	assert(m_data);
...
inline unsigned int DeviceImpl::GetWidth()
{
	assert(m_data);
...
inline unsigned int DeviceImpl::GetHeight()
{
	assert(m_data);
...
inline Result DeviceImpl::SetShadeCount(unsigned int shadeCount)
{
	assert(m_data);
...
// FUNCTION: BETA10 0x1016e490
inline unsigned int DeviceImpl::GetTrianglesDrawn()
{
	assert(m_data);
...
inline Result ViewImpl::ForceUpdate(unsigned int x, unsigned int y, unsigned int width, unsigned int height)
{
	assert(m_data);
